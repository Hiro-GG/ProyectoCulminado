...
namespace wssProyecto.CLIENTE
{
    public partial class Formulario_web12 : System.Web.UI.Page
    {
        ...
        void calcularTotalReserva()
        {
            ...
            {
                hayProductos = true; // ¡Hay cosas en el carrito!
            ...
            // --- CONTROL DE VISIBILIDAD DEL MENSAJE ---
            if (!hayProductos)
            {
                // Si el carrito está vacío, ocultamos todo mensaje de aviso o descuento
            ...
            {
                // Si HAY productos, activamos la lógica del paquete
                lblAvisoPaquete.Visible = true; // Hacemos visible el mensaje
